...
{
    help(argv);
    char wndname[] = "Conan OpenCV-3 + Highgui (with GTK-3)";
    ...
    Size textsize = getTextSize("ConanCenterIndex!", FONT_HERSHEY_COMPLEX, 3, 5, 0);
    ...
    for( i = 0; i < 255; i += 2 )
    {
        ...
        putText(image2, "ConanCenterIndex!", org, FONT_HERSHEY_COMPLEX, 3,
